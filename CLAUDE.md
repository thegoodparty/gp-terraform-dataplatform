...
- **Comments: minimal and informative.** Write a comment only for a non-obvious *why* (a constraint, a gotcha, why one approach over another). Don't restate what the resource block already says. Keep it to a line or two.
